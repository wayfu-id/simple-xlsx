...
import { getOuterXml } from "./dom.js";
import ArrayData from "../structures/ArrayData.js";

/**
 * @typedef { string | typeof Date | number } cellData
 * @typedef { ArrayData<cellData> } rowData
 * @typedef { ArrayData<rowData> } fullData
 *
 * @typedef {{
 *     sheet?: string | number;
 *     trim?: boolean;
 ...
 *  }} parsedFilePath
 *
 * @typedef { ArrayData<{numberFormat:any}> } parsedStyles
 *
 * @typedef {{ row: number, column: number}} docDimension
 *
 * @typedef { docDimension & { value: Object }} parsedCellValue
 *
 * @typedef {{ cells:ArrayData<parsedCellValue>, dimensions:docDimension }} parsedSheetData
 */

/**
 * Checking current value is datetimestamp or not
 * @param {String} styleId
 * @param {ArrayData<{}>} styles
 * @param {{}} options
 * @return {boolean}
 */
 ...
 * @param {ArrayData<string>} values
 * @param {parsedStyles} styles
 * @param {parsedProperties} properties
 * @param {{}} options
 * @returns {ArrayData<parsedCellValue|Element>}
 */
 ...
 * @param {ArrayData<parsedCellValue>} cells
...
export function parseProperties(content) {
    ...
    /** @type {ArrayData<sheetProperties>} */
    properties.sheets = new ArrayData();
...
export function parseSharedStrings(content) {
    if (!content) return new ArrayData();
