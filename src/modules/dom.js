 ...
 * @returns {Element|ArrayData<Element>}
 */
const findChild = (node, tagName, all = false) => {
    let results = new ArrayData();
 ...
 * @param {Element} node
 * @param {tagAttribute | ArrayData<tagAttribute>} attributes
 * @return {Element}
 */
 ...
 * @param {elementItem | Element | ArrayData<elementItem | Element>} items
