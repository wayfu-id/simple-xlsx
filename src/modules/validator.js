...
import { sheetData, cellData } from "../files/worksheet.js";

/**
 * @typedef { import("../modules/parser").sheetProperties } sheetProperties
 *
 * @typedef {{
 *  filename: string,
 *  data: sheetData,
 ...
 * @param {ArrayData<sheetProperties>} sheets
 * @returns
 */
...
export { sheetValidator, isValidCellData, createSheetNotFoundError };
