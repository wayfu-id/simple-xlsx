import { createXml, addXmlElement, createXmlElement } from "../modules/dom.js";
import { generateCellData } from "../modules/utils.js";
 ...
 * @typedef {ArrayData<string | number>} altRowData
 * @typedef {ArrayData<rowData | altRowData>} sheetData
 */
...
const formatCell = (cell, index, rowIndex, doc) => {
    ...
    const cellAttr = (({ type }) => {
        let attr = new ArrayData({ name: "r", value: cellCoordinate });
